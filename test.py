...
n_points = 2000
data = rng.uniform(-1, 1, size = (n_points, 3))
...
mesh.trace(np.asarray([0, 0]), np.asarray([1, 1]), float("inf"))
...
for i, node in enumerate(nodes):
	...
	rect = Rectangle((p1[0], p1[1]), p2[0] - p1[0], p2[1] - p1[1], facecolor = 'none', edgecolor = color, linewidth = 2)
